...
(e.g. C:\Program Files\royale\5.16.1.3725\python\packages) using the Windows PowerShell, 
the command for Royale version 5.16.1.3725 under Windows for example is:
    pip install .\roypypack-5.16.1.3725-cp310-cp310-win_amd64.whl

Linux:
To install the wheel from the Royale Python packages folder (e.g. /home/royale_user/apps/libroyale-5.16.1.3725-LINUX-x86-64Bit/python/packages),
type for Royale version 5.16.1.3725 under Linux for example:
    python3 -m pip install roypypack-5.16.1.3725-cp38-cp38-manylinux_2_31_x86_64.whl
...
Windows:
To build and install your own wheel via the sdist package from the Royale Python packages folder (e.g. C:\Program Files\royale\5.16.1.3725\python\packages) using the Windows PowerShell, type
    pip install .\roypypack-5.16.1.3725.tar.gz --config-settings=cmake.define.ROYALE_DIR="<Royale installation folder>"
whereas the default "<Royale installation folder>" for Royale version 5.16.1.3725 is "C:/Program Files/royale/5.16.1.3725".

Installing the sdist should look similar to the following in MS Windows PowerShell:

PS C:\Program Files\royale\5.16.1.3725\python\packages> pip install .\roypypack-5.16.1.3725.tar.gz --config-settings=cmake.define.ROYALE_DIR="C:\Program Files\royale\5.16.1.3725"
Processing c:\program files\royale\5.16.1.3725\python\packages\roypypack-5.16.1.3725.tar.gz
  Installing build dependencies ... done
  Getting requirements to build wheel ... done
  Installing backend dependencies ... done
  Preparing metadata (pyproject.toml) ... done
Collecting numpy==1.24.2 (from roypypack==5.16.1.3725)
...
Building wheels for collected packages: roypypack
  ...
  Created wheel for roypypack: filename=roypypack-5.16.1.3725-cp311-cp311-win_amd64.whl size=4021954 sha256=d156bd115124a532e9702cc4c85fb214806b7482b5e4c0a8ac7cce84db552caa
...
Successfully installed numpy-1.24.2 roypypack-5.16.1.3725

Linux:
To build and install your own wheel via the sdist package from the Royale Python packages folder (e.g. /home/royale_user/apps/libroyale-5.16.1.3725-LINUX-x86-64Bit/python/packages) using the shell, type
    python3 -m pip install roypypack-5.16.1.3725.tar.gz --config-settings=cmake.define.ROYALE_DIR="<Royale installation folder>"
whereas the "<Royale installation folder>" for Royale version 5.16.1.3725 could be "/home/royale_user/apps/libroyale-5.16.1.3725-LINUX-x86-64Bit" under Linux.
